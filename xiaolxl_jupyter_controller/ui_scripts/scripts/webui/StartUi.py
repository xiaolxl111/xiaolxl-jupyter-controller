    ...
    with rootOut:
        ...
        class InputUIBaseComponent: 
            def __init__(self, input_desc, html_content, configKey):
                ...
                self.input = widgets.Text(description=input_desc,value=get_run_config_value(uiConfig,self.configKey),style={'description_width': 'initial'})
        ...
        class LoginUIComponent: 
            def __init__(self):
                ...
                self.uiBox = VBox([self.name_input, self.pass_input, self.is_open])
