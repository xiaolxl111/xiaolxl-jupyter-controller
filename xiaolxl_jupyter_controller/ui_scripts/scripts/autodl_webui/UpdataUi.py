...
def getUi(data,cmd_run,controllers):
    ...
    with rootOut:
        ui_constructor.add_component(
            widgets.HTML(value="<font size='2' color='red'>【重要】1.更新或进行任何操作前请刷新对应项目</font><br><font size='2' color='red'>【重要】2.更新启动器后关闭笔记本(MainUi.ipynb)点丢弃，再次打开笔记本(MainUi.ipynb)一定记得右上角选择xl_env环境</font><br><font size='2' color='red'>3.如果有网络问题可以开启学术加速</font><br><font size='2' color='red'>4.启动器如果检测到更新可能只是更新了网络数据, 可以选择不更新, 需要更新的时候可以看加速按钮旁边的提示</font>")
        )
