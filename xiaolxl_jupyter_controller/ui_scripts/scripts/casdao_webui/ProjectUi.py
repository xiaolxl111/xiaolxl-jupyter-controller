...
def getUi(data,cmd_run,controllers):
    ...
    network_project_config_json, is_from_network = controllers['jsonFetcher'].fetch_json(data['branch'],"ui_scripts/localtools/serverconfigs/casdao_webui/ServerConfig.json")
